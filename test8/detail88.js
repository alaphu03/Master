...
function renderPokemonsInfor(PokemonCard){
    ...
    for (var type= 0; type< pokemontype.length; type++){
        ...
        var typeHTML=`
        <img id='typeIMG' src='https://pokeguide.neocities.org/Pic/flyingicon.png'> 
        `
...
function renderPokemonsDes(Pokemon_des) {
    ...
    // console.log(arr)
    pokemonDesHTML =`<div class="Description"><h1 class='DEs'>Description</h1><br>${DesString}
    <br>
    <br>
    <h1 class="StatContainer" >Pokemon's Stats</h1>
    <div class="statBar" style="background-color: #cfc ; padding: 10px; border: 1px solid green; width: 666.5px;">HP</div>
    <div class="statBar" style="background-color: #cfc ; padding: 10px; border: 1px solid green; width: 666.5px;">Attack</div>
    <div class="statBar" style="background-color: #cfc ; padding: 10px; border: 1px solid green; width: 666.5px;">Defense</div>
    <div class="statBar" style="background-color: #cfc ; padding: 10px; border: 1px solid green; width: 666.5px;">Sp.Atk</div>
    <div class="statBar" style="background-color: #cfc ; padding: 10px; border: 1px solid green; width: 666.5px;">Sp.Def</div>
    <div class="statBar" style="background-color: #cfc ; padding: 10px; border: 1px solid green; width: 666.5px;">Speed</div>
    </div>`
